...
| `.fxmind/audits/<resource>.md` | Audit reports (generated by `/fxmind audit`) |
| `.fxmind/audit.template.md` | Audit report skeleton (read-only) |
| `.fxmind/*.template.md` | Other report/memory skeletons (read-only) |
