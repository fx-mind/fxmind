...
- **fivem-skill** → `.fxmind/skills/fivem-development/` — `performance.md` §1.6.1 · §2.2 · §4.2 · `audit-passes.md` §2.3–**§2.5** · `architecture.md` §3.6 · `security.md` §5.1 · `communication.md` §1.1
